    ...
    >
      ...
      <div className="card-body d-flex flex-column p-3">
        ...
        <p className="card-text flex-grow-1 mb-3" style={{ 
          ...
          {desc?.length > 80 ? `${desc.slice(0, 80)}...` : desc || 'No description available.'}
        </p>

        {/* Compact Movie Details */}
        <div className="row mb-3">
          <div className="col-6">
            <div className="text-center p-1 rounded" style={{ 
              ...
              <div style={{ color: mode ? '#999999' : '#888888', fontSize: '0.7rem', fontWeight: '600' }}> RELEASE</div>
              <div style={{ color: mode ? '#000000' : '#ffffff', fontWeight: '700', fontSize: '0.75rem' }}>
                {new Date(pub).getFullYear()}
              </div>
            </div>
          </div>
          <div className="col-6">
            <div className="text-center p-1 rounded" style={{ 
              ...
              <div style={{ color: mode ? '#999999' : '#888888', fontSize: '0.7rem', fontWeight: '600' }}> LANG</div>
              <div style={{ color: mode ? '#000000' : '#ffffff', fontWeight: '700', fontSize: '0.75rem' }}>
        ...
        <div className="d-grid gap-2 mt-auto">
          ...
          <button
            onClick={handleTrailer}
            className="btn fw-bold py-2 border-2"
            style={{
              background: 'transparent',
              borderColor: '#e50914',
              color: '#e50914',
